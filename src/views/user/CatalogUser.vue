    ...
    <UserLayout>
        <div class="grid grid-cols-4 px-32 py-10">
                ...
                <div class="mt-4 bg-gray-light w-4/5 rounded divide-y-2 shadow">
                    <div>
                        ...
                        <div v-if="showDiscount" class="flex items-center gap-1 px-6 pb-2">
                            <input id="discount" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                    ...
                    <div>
                        ...
                        <div v-if="showCategory" class="px-6 pb-2">
                            <div class="flex items-center gap-1 mb-2">
                                <input id="category" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="category" class="text-sm">Mobile Phone</label>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div v-if="showBrand" class="px-6 pb-2">
                            <div class="flex items-center gap-1 mb-2">
                                <input id="brand" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                    ...
                    <div>
                        ...
                        <div v-if="showSort" class="px-6 pb-2">
                            <div class="flex items-center gap-1 mb-2">
                                <input id="sort" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
            ...
            <div class="col-span-3">
                <p class="mb-6">Page 1 of 10 for <b>All Products</b></p>
